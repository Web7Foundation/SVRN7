...
.DESCRIPTION
    Implements the did:drn:svrn7.net/protocols/Svrn7.Presence.0.8.0/* DIDComm protocol.
...
.NOTES
    Protocol URIs:
        did:drn:svrn7.net/protocols/Svrn7.Presence.0.8.0/status      — publish/receive status
        did:drn:svrn7.net/protocols/Svrn7.Presence.0.8.0/subscribe   — subscribe to peer status
        did:drn:svrn7.net/protocols/Svrn7.Presence.0.8.0/unsubscribe — cancel subscription
...
function Update-Web7Presence {
    ...
    .DESCRIPTION
        ...
        Protocol: did:drn:svrn7.net/protocols/Svrn7.Presence.0.8.0/status
...
# ── Add-Web7PresenceSubscription ───────────────────────────────────────────────

function Add-Web7PresenceSubscription {
    <#
    .SYNOPSIS
...
# ── Publish-Web7Presence ───────────────────────────────────────────────────────

function Publish-Web7Presence {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        Publish-Web7Presence -Status Available
        Publish-Web7Presence -Status Busy -TtlSeconds 3600
    #>
    [CmdletBinding()]
    param(
        [Parameter(Mandatory)]
...
function Get-Web7Presence {
    ...
    .EXAMPLE
        Get-Web7Presence -Did "did:drn:beta.svrn7.net"
    #>
    [CmdletBinding()]
