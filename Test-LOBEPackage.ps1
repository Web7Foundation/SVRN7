...
Write-Check ".psd1 manifest present (recommended)" ([bool]($lobeNames | Where-Object { $_ -like '*.psd1' })) -isWarn:(-not ($lobeNames | Where-Object { $_ -like '*.psd1' }))
